...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="file-preview file-preview-colors {class}">\n' +
                '    {close}' +
                '    <div class="{dropClass}">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="glyphicon glyphicon-trash demand--none"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphicon glyphicon-folder-open demand--none"></i>&nbsp;',
